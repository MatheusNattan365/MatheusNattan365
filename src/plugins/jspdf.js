...
export default new Vue({
     methods:{
                ...
                doc.text(`${object.nome}`, 48, 29)
                doc.text(`${object.idade}`, 153, 29)

                doc.text(`${object.solicitante}`, 63, 38)
                doc.setFontSize(8)
                doc.text(`${object.id}`, 158, 38)

                doc.setFontSize(10)
                doc.text(`${object.convenio}`, 55, 47)
                doc.text(`${datas(object.dataDaColeta)}`, 152, 47)
